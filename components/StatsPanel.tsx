  ...
  return (
    <div className="space-y-8 animate-fade-in pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border-t-4 border-primary hover:shadow-md transition">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-t-4 border-secondary hover:shadow-md transition">
          <div className="flex justify-between items-start">
             <div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border-t-4 border-slate-500 hover:shadow-md transition">
           <div className="flex justify-between items-start">
              <div>
                  <h3 className="text-slate-500 text-xs font-bold uppercase tracking-wider mb-1">Tiempo Medio</h3>
                  <p className="text-4xl font-black text-slate-700">{resolutionTime}<span className="text-xl align-top opacity-50">h</span></p>
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl shadow-sm border border-primary/10">
          <h3 className="text-lg font-bold mb-6 text-primary flex items-center gap-2 pb-4 border-b border-gray-50">
