    ...
    <div className="flex flex-col min-h-[85vh] animate-fade-in pb-10">
      ...
      <section className="relative w-full py-24 px-4 overflow-hidden min-h-[600px] flex items-center">
        ...
        <div className="container mx-auto max-w-5xl text-left relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 rounded-full bg-white/80 backdrop-blur-sm border border-white/40 shadow-sm text-primary text-sm font-semibold animate-fade-in">
          ...
          <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tight text-slate-900 leading-[0.9]">
            Tu barrio, <br />
          ...
          <p className="text-xl md:text-2xl text-slate-600 max-w-xl mb-10 font-medium leading-relaxed drop-shadow-sm">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-start gap-4">
            ...
            <button
              onClick={onStart}
              className="px-8 py-4 rounded-full font-bold text-lg bg-white/80 backdrop-blur-sm text-slate-700 border border-white/50 hover:bg-white transition-all shadow-sm hover:shadow-md w-full sm:w-auto"
            >
              Explorar Mapa
            </button>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:-translate-y-2 transition-transform duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl flex items-center justify-center mb-6 text-primary">
                <Camera size={28} />
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-800">1. Captura</h3>
            ...
            {/* Card 2 */}
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-24 h-24 bg-secondary/10 rounded-bl-[100px] -z-10"></div>
              <div className="w-14 h-14 bg-gradient-to-br from-teal-100 to-teal-50 rounded-2xl flex items-center justify-center mb-6 text-secondary">
                <MapPin size={28} />
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-800">2. Geolocaliza</h3>
              <p className="text-slate-500 leading-relaxed">
            ...
            {/* Card 3 */}
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100 hover:-translate-y-2 transition-transform duration-300">
              <div className="w-14 h-14 bg-gradient-to-br from-yellow-100 to-yellow-50 rounded-2xl flex items-center justify-center mb-6 text-yellow-600">
                <CheckCircle size={28} />
              </div>
              <h3 className="text-xl font-bold mb-3 text-slate-800">3. Resuelve</h3>
              <p className="text-slate-500 leading-relaxed">
