      ...
      <div className="bg-white dark:bg-slate-900 dark:text-slate-100 rounded-lg shadow-lg w-full max-w-md overflow-hidden animate-fade-in border border-transparent dark:border-slate-800">
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {isRegister && (
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Nombre Completo</label>
                <input
                  type="text"
                  value={name}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Correo electrónico</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Contraseña</label>
              <div className="relative">
            ...
            {isRegister && (
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Confirmar Contraseña</label>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-slate-400 w-4 h-4" />
                  <input
                    type="password"
